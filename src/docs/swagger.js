...
const doc = {
    ...
    tags: [
        ...
        {name: "Admin/Entreprises", description: "The administration entreprise part of the application"},
        {name: "Admin/Companies", description: "The administration companies part of the application"},
        {name: "HR/Staffs", description: "The human resources staffs part of the application"},
        {name: "Process/AnalyseData", description: "The data management encoding"},
        {
            name: "HR",
...
const endpointsFiles = ['./app/routes/home.js',
'./app/routes/entreprises.js',
'./app/routes/companies.js'
                ]
