...
// GET : findAll
machinesDriversRouter.get("/", async (request: Request, response: Response) => {
  try {
...
// GET : findById
machinesDriversRouter.get("/:id", async (request: Request, response: Response) => {
